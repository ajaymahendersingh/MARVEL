...
int main(void){
    ...
    struct tvmgen_default_inputs inputs = {
            .serving_default_input_10_0 = (void*)&CAR_IMAGE,
    };
    ...
    printf("Evaluating ResNet50 model using microTVM:\n");

    inputs.serving_default_input_10_0 = (void*)&CAR_IMAGE;
    tvmgen_default_run(&inputs, &outputs1);
    printf("Car Result: random = %d, car = %d\n", output1[0], output1[1]);

    inputs.serving_default_input_10_0 = (void*)&CATAN_IMAGE;
